                                            ...
                                            <ItemTemplate>
                                                <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                                                    ...
                                                    <td class="p-4 align-middle">
                                                        <div class="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-primary text-primary-foreground hover:bg-primary/80" data-v0-t="badge"><%# Eval("BorrowedBooksCount") %> cuốn</div>
                                                    </td>
                                                    <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
    ...
    <script> 
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.store('pagination', {
                ...
                canGo(p) {
                    return this.total / this.limit >= p;
                },
                get canPrivPage() {
